...
def analysis():
    ...
    import matplotlib.pyplot as plt     #from this error occurs
...
def openphoto():
    ...
    fileName = askopenfilename(initialdir='D:/Disease detection in plants/test/test', title='Select image for analysis ',
                           filetypes=[('image files', '.jpg')])
    dst = "D:/Disease detection in plants/testpicture/testpicture"
